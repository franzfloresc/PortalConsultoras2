...
namespace Portal.Consultoras.Data.RevistaDigital
{
    public class DARevistaDigitalSuscripcion : DataAccess
    {
        ...
        public int Suscripcion(BERevistaDigitalSuscripcion entity)
        {
            ...
            //Context.Database.AddInParameter(command, "FechaSuscripcion", DbType.DateTime, entity.FechaSuscripcion);
            Context.Database.AddInParameter(command, "EstadoRegistro", DbType.Int32, 1);
