...
namespace Portal.Consultoras.Web.ServiceEvaluacionCrediticia {
    ...
    public interface IEvaluacionCrediticiaService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvaluacionCrediticiaService/ConsultarServicioCrediticioCam", ReplyAction="http://tempuri.org/IEvaluacionCrediticiaService/ConsultarServicioCrediticioCamRes" +
            "ponse")]
        Portal.Consultoras.Web.ServiceEvaluacionCrediticia.EvaluacionCrediticiaBE ConsultarServicioCrediticioCam(string codigoIso, string numeroDocumento);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvaluacionCrediticiaService/ConsultarServicioCrediticioCam", ReplyAction="http://tempuri.org/IEvaluacionCrediticiaService/ConsultarServicioCrediticioCamRes" +
            "ponse")]
        System.Threading.Tasks.Task<Portal.Consultoras.Web.ServiceEvaluacionCrediticia.EvaluacionCrediticiaBE> ConsultarServicioCrediticioCamAsync(string codigoIso, string numeroDocumento);
    }
    ...
    public partial class EvaluacionCrediticiaServiceClient : System.ServiceModel.ClientBase<Portal.Consultoras.Web.ServiceEvaluacionCrediticia.IEvaluacionCrediticiaService>, Portal.Consultoras.Web.ServiceEvaluacionCrediticia.IEvaluacionCrediticiaService {
        ...
        public Portal.Consultoras.Web.ServiceEvaluacionCrediticia.EvaluacionCrediticiaBE ConsultarServicioCrediticioCam(string codigoIso, string numeroDocumento) {
            return base.Channel.ConsultarServicioCrediticioCam(codigoIso, numeroDocumento);
        }
        
        public System.Threading.Tasks.Task<Portal.Consultoras.Web.ServiceEvaluacionCrediticia.EvaluacionCrediticiaBE> ConsultarServicioCrediticioCamAsync(string codigoIso, string numeroDocumento) {
            return base.Channel.ConsultarServicioCrediticioCamAsync(codigoIso, numeroDocumento);
        }
    }
}
