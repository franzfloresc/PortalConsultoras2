...
namespace Portal.Consultoras.Web.ServiceODS {
    ...
    public interface IODSService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IODSService/SelectProductoByCodigoDescripcionSearchRegionZona", ReplyAction="http://tempuri.org/IODSService/SelectProductoByCodigoDescripcionSearchRegionZonaR" +
            "esponse")]
        Portal.Consultoras.Web.ServiceODS.BEProducto[] SelectProductoByCodigoDescripcionSearchRegionZona(int paisID, int campaniaID, string codigoDescripcion, int RegionID, int ZonaID, string CodigoRegion, string CodigoZona, int criterio, int rowCount, bool validarOpt, string CodigoPrograma, int NumeroPedido);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IODSService/SelectProductoByCodigoDescripcionSearchRegionZona", ReplyAction="http://tempuri.org/IODSService/SelectProductoByCodigoDescripcionSearchRegionZonaR" +
            "esponse")]
        System.Threading.Tasks.Task<Portal.Consultoras.Web.ServiceODS.BEProducto[]> SelectProductoByCodigoDescripcionSearchRegionZonaAsync(int paisID, int campaniaID, string codigoDescripcion, int RegionID, int ZonaID, string CodigoRegion, string CodigoZona, int criterio, int rowCount, bool validarOpt, string CodigoPrograma, int NumeroPedido);
    ...
    public partial class ODSServiceClient : System.ServiceModel.ClientBase<Portal.Consultoras.Web.ServiceODS.IODSService>, Portal.Consultoras.Web.ServiceODS.IODSService {
        ...
        public Portal.Consultoras.Web.ServiceODS.BEProducto[] SelectProductoByCodigoDescripcionSearchRegionZona(int paisID, int campaniaID, string codigoDescripcion, int RegionID, int ZonaID, string CodigoRegion, string CodigoZona, int criterio, int rowCount, bool validarOpt, string CodigoPrograma, int NumeroPedido) {
            return base.Channel.SelectProductoByCodigoDescripcionSearchRegionZona(paisID, campaniaID, codigoDescripcion, RegionID, ZonaID, CodigoRegion, CodigoZona, criterio, rowCount, validarOpt, CodigoPrograma, NumeroPedido);
        }
        
        public System.Threading.Tasks.Task<Portal.Consultoras.Web.ServiceODS.BEProducto[]> SelectProductoByCodigoDescripcionSearchRegionZonaAsync(int paisID, int campaniaID, string codigoDescripcion, int RegionID, int ZonaID, string CodigoRegion, string CodigoZona, int criterio, int rowCount, bool validarOpt, string CodigoPrograma, int NumeroPedido) {
            return base.Channel.SelectProductoByCodigoDescripcionSearchRegionZonaAsync(paisID, campaniaID, codigoDescripcion, RegionID, ZonaID, CodigoRegion, CodigoZona, criterio, rowCount, validarOpt, CodigoPrograma, NumeroPedido);
        }
