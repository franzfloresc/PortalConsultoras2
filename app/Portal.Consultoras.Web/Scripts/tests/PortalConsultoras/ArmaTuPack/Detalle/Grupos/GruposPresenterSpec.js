...
describe("ArmaTuPack - Detalle - Grupo - GrupoPresenter", function () {
    ...
    describe("deleteComponent", function () {
        ...
        it("should throw an exception when cuvComponente is undefined", function () {
            ...
            try {
                gruposPresenter.deleteComponente(0, undefined);
            } catch (error) {
                errorMsg = error;
            }
        ...
        it("should throw an exception when cuvComponente is null", function () {
            ...
            try {
                gruposPresenter.deleteComponente(0, null);
            } catch (error) {
                errorMsg = error;
            }
        ...
        it("should not delete component when grupo do not exists", function () {
            gruposPresenter.deleteComponente(303790, 304050);
