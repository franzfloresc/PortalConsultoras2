...
function ModalBeneficios(index) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#m_montoMinimo").append("Monto mínimo para lograr: <span>S/ " + data.Niveles[0].MontoMinimo + ".00</span>");
            ...
            for (var i = 0; i <= data.Niveles[0].Beneficios.length - 1; i++) {
                ...
                Html += "<div class='txt-benf'><p class='text-bold'>" + data.Niveles[0].Beneficios[i].Descripcion + "<span>" + data.Niveles[0].Beneficios[i].NombreBeneficio + "</span></p></div>";
                Html += "</li>";
            }
