                            ...
                            + '<div style="width:{wText}px;position: absolute; top:-15px;" data-texto>'
                                + '<div class="contenedor_tippingPoint">'
                                    + '<div class="tippingPoint {estado}"></div>'
                                        + '<div class="monto_meta_tippingPoint">' + vbSimbolo + dataTP.TippingPointMontoStr + '</div>'
                                    + '<div class="tooltip_regalo_meta_tippingPoint">'
                                        ...
                                        + '</div>'
                                            + '<div class="tooltip_producto_regalo_descripcion">Llega a <span>' + vbSimbolo + dataTP.TippingPointMontoStr + '</span><br>y llévate de regalo<br><strong>' + dataTP.DescripcionCUV2 + '</strong></div>'
                                    + '</div>'
                                + '</div>'
                            + '</div>'
