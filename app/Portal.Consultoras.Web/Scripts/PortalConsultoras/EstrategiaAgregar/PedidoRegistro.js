...
var ControllerRegistro = "PedidoRegistro/"
var urlAgregarUnico = "PedidoRegistro/PedidoAgregarProductoTransaction"
...
function InsertarPedidoCuvBanner(CUVpedido, CantCUVpedido) {
    ...
    jQuery.ajax({
        type: 'POST',
        url: baseUrl + ControllerRegistro + 'InsertarPedidoCuvBanner',
        dataType: 'json',
...
function AgregarProductoOfertaLiquidacion(xthis) {
...
function AgregarProductoOfertaLiquidacionMobile(article) {
...
/* Ini - Region Liquidacion Bienvenida */
function AgregarProductoLiquidacionBienvenida(contenedor) {
...
/* Fin - Region Liquidacion Bienvenida */
...
function AgregarOfertaFinalClick(xthis) {
...
function AgregarOfertaFinalDetalleClick(xthis) {
...
function AgregarOfertaFinal(model) {
    ...
    else add = InsertarProductoPorUrl(model, false, 'PedidoAgregarProductoTransaction');
    OpenLoadingOF();
...
function InsertarProductoPorUrl(model, asyncX, urlMobile) {
...
function AgregarProductoPorUrl(url, model, divDialog, cerrarSplash, asyncX) {
    AbrirSplash();
...
function AgregarProductoListadoPasePedido() {
...
function InsertarProductoPasePedido(form) {
...
function AgregarProductoListadoPasePedidoMobile() {
    ShowLoading();
        ...
        success: function (datos) {
            if (checkTimeout(datos)) {
                if (!datos.result) {
                    ...
                    InsertarProductoPasePedidoMobile();
                    return true;
                }
            }
        },
...
function InsertarProductoPasePedidoMobile() {
