    ...
    var _insertarProductoPasePedidoMobile = function () {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (existeError == "1") {
                    $("#divProductoObservaciones").html('<div class="alert-top-icon text-danger" style="margin-top: 0;"><i class="icon-exclamation-circle"></i><br/>OcurriÃ³ un error al ejecutar la operaciÃ³n.</div>');
                    $("#btnAgregarProducto").show();
...
function UpdateTransaction(CantidadActual, CampaniaID, PedidoID, PedidoDetalleID, TipoOfertaSisID, CUV, esCuponNuevas, rowElement, txtLPCant, setId, txtLPTempCant) {
    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            //Se pone aquÃ­ el nuevo mensaje para TESLA-07
