...
var WeekHeadColor = "#3f9ad6"; //var WeekHeadColor="#18861B";//Background Color in Week header.
...
var TodayColor = "#c5c5c5"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#a7c6da"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
...
var imageFilesPath = "../../Content/Images/dateTimePicker/";
...
function RenderCssCal(bNewCal) {
    ...
    if (Cal.ShowTime === true) {
        ...
        vCalTime += "<td width='22px'><input type='text' name='hour' maxlength=2 size=1 style='WIDTH: 25px;text-align:  center;font-family:  museo_sans_700regular;' value=" + showHour + " onkeyup=\"javascript:Cal.SetHour(this.value)\">";
        vCalTime += "</td><td style='font-weight:bold;text-align:center;'>:</td><td width='22px'>";
        vCalTime += "<input type='text' name='minute' maxlength=2 size=1 style='WIDTH: 25px;text-align:  center;font-family:  museo_sans_700regular;' value=" + Cal.Minutes + " onkeyup=\"javascript:Cal.SetMinute(this.value)\">";

        if (Cal.ShowSeconds) {
            vCalTime += "</td><td style='font-weight:bold;'>:</td><td width='22px'>";
            vCalTime += "<input type='text' name='second' maxlength=2 size=1 style='WIDTH: 25px;text-align:  center;font-family:  museo_sans_700regular;' value=" + Cal.Seconds + " onkeyup=\"javascript:Cal.SetSecond(parseInt(this.value,10))\">";
        }
        ...
        vCalTime += "<tr><td colspan='8' style=\"text-align:center;\"><input style='width:60px;font-size:12px;margin-top:10px;border-radius: 10px;background: #4597cb;color: white;border:  0;' onClick='javascript:closewin(\"" + Cal.Ctrl + "\");'  type=\"button\" value=\"OK\">&nbsp;<input style='width:60px;font-size:12px;border-radius: 10px;background: #4597cb;color: white;border:  0;' onClick='javascript: winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Cancel\"></td></tr>";
    }
    ...
    if (!winCal) {
        ...
        cssStr = ".calTD {font-family: 'museo_sans_700regular'; font-size: 12px; text-align: center; border:0; }\n";
        cssStr += ".calR {font-family: 'museo_sans_700regular'; font-size: 16px; text-align: center; font-weight: bold;}";
