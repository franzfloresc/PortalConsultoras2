...
namespace Portal.Consultoras.Web.Models
{
    public class MisDatosModel
    {
        ...
        public string CadenaParametrosUTMs {get {return @"utm_source=Transactional&utm_medium=email&utm_content=ConfirmarCuenta&utm_campaing=RegistroShowRoomIntriga{{NOMBRE_EVENTO}}"; }
        }
    }
}