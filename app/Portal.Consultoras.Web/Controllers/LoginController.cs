...
namespace Portal.Consultoras.Web.Controllers
{
    public class LoginController : Controller
    {
                    ...
                    if (usuarioModel.RolID == Constantes.Rol.Consultora)
                    {
                        ...
                        try
                        {
                            ...
                            if (configuracionesPaisModels.Any())
                            {
                                ...
                                revistaDigitalModel.CampaniaMasDos = Util.AddCampaniaAndNumero(Convert.ToInt32(usuarioModel.CampaniaID), 2, usuarioModel.NroCampanias) % 100;
        ...
        private void ConfiguracionPaisRevistaDigital(ref RevistaDigitalModel revistaDigitalModel, UsuarioModel usuarioModel)
        {
            ...
            revistaDigitalModel.CampaniaFuturoActiva = Util.SubStr(Util.AddCampaniaAndNumero(usuarioModel.CampaniaID, revistaDigitalModel.CantidadCampaniaEfectiva, usuarioModel.NroCampanias).ToString(), 4, 2);
            ...
            {
                var ca = Util.AddCampaniaAndNumero(revistaDigitalModel.SuscripcionEfectiva.CampaniaID, revistaDigitalModel.CantidadCampaniaEfectiva, usuarioModel.NroCampanias);
            ...
            else if (revistaDigitalModel.SuscripcionEfectiva.EstadoRegistro == Constantes.EstadoRDSuscripcion.SinRegistroDB)
            {
                ...
                {
                    var ca = Util.AddCampaniaAndNumero(revistaDigitalModel.SuscripcionModel.CampaniaID, revistaDigitalModel.CantidadCampaniaEfectiva, usuarioModel.NroCampanias);
