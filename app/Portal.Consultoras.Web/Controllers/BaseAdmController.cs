...
namespace Portal.Consultoras.Web.Controllers
{
    ...
    public partial class BaseAdmController : BaseController
    {
        ...
        {
            IEnumerable<CampaniaModel> lst = _zonificacionProvider.GetCampanias(PaisID);
            string habilitarNemotecnico = _tablaLogicaProvider.GetTablaLogicaDatoCodigo(PaisID, ConsTablaLogica.Plan20.TablaLogicaId, Constantes.TablaLogicaDato.BusquedaNemotecnicoProductoSugerido);
            return Json(new
            {
                lista = lst,
