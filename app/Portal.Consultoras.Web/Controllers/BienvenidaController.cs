    ...
    public class BienvenidaController : BaseController
    {
        ...
        public JsonResult RegistrarDonacionConsultora(string CodigoISO, string CodigoConsultora, string Campania, int ComunicadoID)
        {
            try
            {
                ...
                var mensaje = string.Format("�Gracias por ayudar a la familia �sika a reconstruir su vida! Tu donaci�n ser� cargada a tu estado de cuenta de pedido de campa�a {0}", Campania.Substring(4));
