...
namespace Portal.Consultoras.Web.Controllers
{
    public class MisReclamosController : BaseAdmController
    {
        ...
        public JsonResult BuscarCuvCambiar(MisReclamosModel model)
        {
            ...
            {
                olstProducto = sv.SelectProductoByCodigoDescripcionSearchRegionZona(userData.PaisID, model.CampaniaID, model.CUV, userData.RegionID, userData.ZonaID, userData.CodigorRegion, userData.CodigoZona, 1, 1, false,
