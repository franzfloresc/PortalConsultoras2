...
namespace Portal.Consultoras.Web.Controllers
{
    public class OfertaLiquidacionController : BaseAdmController
    {
        ...
        public JsonResult ObtenerCampaniasYConfiguracionPorPais(int PaisID)
        {
            ...
            string habilitarNemotecnico = _tablaLogicaProvider.GetTablaLogicaDatoCodigo(PaisID, ConsTablaLogica.Plan20.TablaLogicaId, Constantes.TablaLogicaDato.BusquedaNemotecnicoOfertaLiquidacion);
