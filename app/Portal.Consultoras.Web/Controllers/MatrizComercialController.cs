...
{
    public class MatrizComercialController : BaseAdmController
    {
        ...
        public JsonResult ObtenerISOPais(int paisID)
        {
            ...
            if (paisID > 0)
            {
                ...
                if (iso != "")
                {
                    habilitarNemotecnico = _tablaLogicaProvider.GetTablaLogicaDatoCodigo(paisID, ConsTablaLogica.Plan20.TablaLogicaId, Constantes.TablaLogicaDato.BusquedaNemotecnicoMatriz);
                }
            }
            return Json(new
            {
