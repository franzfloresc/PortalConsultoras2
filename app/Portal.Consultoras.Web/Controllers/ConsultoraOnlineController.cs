...
namespace Portal.Consultoras.Web.Controllers
{
    public class ConsultoraOnlineController : BaseController
    {
        ...
        public string mensajeConsultora(string consultora, string url)
        {
            ...
            string mailing_03 = ConfigCdn.GetUrlFileCdn(carpetaPais, "1-Mailing_03.png");
            string mailing_05 = ConfigCdn.GetUrlFileCdn(carpetaPais, "1-Mailing_05.png");
        ...
        public JsonResult AceptarPedido(ConsultoraOnlinePedidoModel pedido)
        {
            ...
            // 0=App Catalogos, >0=Portal Marca
            if (_pedido.MarcaID == 0)
            {
                tipo = 1;
                marcaPedido = _pedido.MedioContacto;
            }
            else
            {
                tipo = 2;
                marcaPedido = _pedido.Marca;
            }
            ...
            try
            {
                using (ServiceSAC.SACServiceClient svc = new ServiceSAC.SACServiceClient())
                {
                    ...
                    beSolicitudCliente.SolicitudClienteID = _pedido.PedidoId;
                ...
                {
                    if (item.PedidoId == _pedido.PedidoId)
                    {
                        item.Estado = "A";
                ...
                if (_pedido.FlagMedio == "01")
                {
                    ...
                    mensajecliente.Append("<span style='display: block; color: #7f7f7f; font-size: 16px; text-align: left; font-family: Arial, Helvetica, sans-serif; margin: 0.4em 0 0 0em;'>Hola " + _pedido.Cliente.Split(' ').First() + "</span>");
                    ...
                    mensajecliente.Append("</span>");
                    mensajecliente.Append("<br>");
                    mensajecliente.Append("<span style='color: #7f7f7f; font-size: 14px; text-align: left; font-family: Arial, Helvetica, sans-serif;'> " + _pedido.Cliente + "<br>");
                    mensajecliente.Append(_pedido.Email + "<br>");
                    mensajecliente.Append(_pedido.Telefono);
                    mensajecliente.Append("</span>");
                    mensajecliente.Append("</span>");
                    mensajecliente.Append("</td>");
                    ...
                    mensajecliente.Append("<span style='color: #7f7f7f; font-size: 11px; text-align: left; font-family: Arial, Helvetica, sans-serif; line-height: 1em'>FECHA: " + String.Format("{0:dd/MM/yyyy}", _pedido.FechaSolicitud) + "<br>");
                    mensajecliente.Append("CAMPAÑA: " + _pedido.Campania + "<br>");
                    mensajecliente.Append("</span>");
                    mensajecliente.Append("</span>");
                    mensajecliente.Append("</td>");
                    mensajecliente.Append("</tr>");
                    ...
                    try
                    {
                        ...
                        {
                            Common.Util.EnviarMail3Mobile(emailDe, _pedido.Email, titulocliente, mensajecliente.ToString(), true, _pedido.Email);
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        {
                            Common.Util.EnviarMail3Mobile(emailDe, _pedido.Email, titulo, mensaje.ToString(), true, string.Empty);
                        }
                    }
                    catch (Exception ex)
                    {
        ...
        public string mensajeRechazoPedido(string consultora, string contextoBase, Portal.Consultoras.Web.ServiceSAC.BESolicitudCliente SolicitudCliente)
        {
            ...
            mensaje.AppendLine("<td style=\"text-align:center;\">");
            mensaje.AppendLine("<table id=\"Table_01\" width=\"682\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" align=\"center\" bgcolor=\"#ffffff\" style=\"color:#768ea3;\">");
            mensaje.AppendLine(String.Format("	<tr><td colspan=\"7\"><img src=\"{0}\" width=\"682\" height=\"117\" alt=\"\"></td><tr>", ConfigCdn.GetUrlFileCdn(carpetaPais, "1-Mailing_01.png")));
            mensaje.AppendLine("	<tr>");
            mensaje.AppendLine(String.Format("		<td><img src=\"{0}\" width=\"54\" height=\"148\" alt=\"\"></td>", ConfigCdn.GetUrlFileCdn(carpetaPais, "1-Mailing_03.png")));
            mensaje.AppendLine("		<td colspan=\"3\" style=\"text-align:left; padding-top:50px; padding-bottom:20px; font-size:18px;\">");
            mensaje.AppendLine(String.Format("        	Hola, {0}<br/><br/>", consultora));
            ...
            mensaje.AppendLine("        </td>");
            mensaje.AppendLine(String.Format("		<td colspan=\"3\"><img src=\"{0}\" width=\"71\" height=\"148\" alt=\"\"></td>", ConfigCdn.GetUrlFileCdn(carpetaPais, "1-Mailing_05.png")));
            mensaje.AppendLine("	</tr>");
            mensaje.AppendLine("	<tr>");
            mensaje.AppendLine("		<td colspan=\"7\" style=\"text-align:center; padding-top:30px; padding-bottom:50px\">");            
            mensaje.AppendLine(String.Format("			<a href=\"{0}Pedido/Index?lanzarTabConsultoraOnline=true\" target=\"_blank\"><img src=\"{1}\" width=\"201\" height=\"38\" border=\"0\" alt=\"Ver pedido\"></a>", contextoBase, ConfigCdn.GetUrlFileCdn(carpetaPais, "7-Mailing_03.png")));
            mensaje.AppendLine("		</td>");
            mensaje.AppendLine("	</tr>");
            mensaje.AppendLine("	<tr>");
            mensaje.AppendLine("		<td colspan=\"7\" style=\"background-color:#acbbc9;\">");
