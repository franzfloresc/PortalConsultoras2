<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ErrorPage.aspx.cs" Inherits="Portal.Consultoras.Web.WebPages.ErrorPage" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="boton_modal">
            <div class="input_search">
                <asp:Button ID="btnRegresar" runat="server" Text="Ir al Sitio" OnClick="btnRegresar_Click" />
            </div>
        </div>
    </form>
</body>
