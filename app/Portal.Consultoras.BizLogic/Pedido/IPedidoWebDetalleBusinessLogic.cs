...
namespace Portal.Consultoras.BizLogic
{
    public interface IPedidoWebDetalleBusinessLogic
    {
        ...
        void DelPedidoWebDetalleTransaction(BEPedidoWebDetalle pedidowebdetalle);
        ...
        IList<BEPedidoWebDetalle> GetPedidoWebDetalleByCampania(BEPedidoWebDetalleParametros detParametros);
        IList<BEPedidoWebDetalle> GetPedidoWebDetalleByCampania(BEPedidoWebDetalleParametros detParametros, bool consultoraOnLine, bool updLabelNuevas);
        IList<BEPedidoWebDetalle> GetPedidoWebDetalleByCampania(BEPedidoWebDetalleParametros detParametros, bool consultoraOnLine, bool updLabelNuevas, bool updLabelCaminoBrillante);
        ...
        BEPedidoWebDetalle InsPedidoWebDetalleTransaction(BEPedidoWebDetalle pedidowebdetalle);
        ...
        void UpdPedidoWebDetalleTransaction(BEPedidoWebDetalle pedidowebdetalle);
        ...
        bool InsertPedidoWebSetTransaction(int paisID, int Campaniaid, int PedidoID, int CantidadSet, string CuvSet, long ConsultoraId, string CodigoUsuario, string CuvsStringList, int EstrategiaId, int ClienteID, int TipoEstrategiaID);
