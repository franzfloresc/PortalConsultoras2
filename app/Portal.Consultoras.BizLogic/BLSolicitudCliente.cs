        ...
        private void EnviarEmailSolicitudCliente(int paisID, BEConsultoraSolicitudCliente consultoraSolicitudCliente, BEResultadoSolicitud resultado)
        {
            ...
            if (consultoraSolicitudCliente != null)
            {
                try
                {
                    ...
                    mensajeCorreo.AppendLine(String.Format("<tr><td colspan=\"7\"><img src=\"{0}\" width=\"682\" height=\"117\" alt=\"\"></td><tr>", ConfigS3.GetUrlFileCdn(carpetaPais, "1-Mailing_01.png")));
                    mensajeCorreo.AppendLine("<tr>");
                    mensajeCorreo.AppendLine(String.Format("<td><img src=\"{0}\" width=\"54\" height=\"148\" alt=\"\"></td>", ConfigS3.GetUrlFileCdn(carpetaPais, "1-Mailing_03.png")));
                    ...
                    mensajeCorreo.AppendLine(String.Format("<td colspan=\"3\"><img src=\"{0}\" width=\"71\" height=\"148\" alt=\"\"></td>", ConfigS3.GetUrlFileCdn(carpetaPais, "1-Mailing_05.png")));
                    mensajeCorreo.AppendLine("</tr>");
                    mensajeCorreo.AppendLine("<tr>");
                    mensajeCorreo.AppendLine("<td colspan=\"7\" style=\"text-align:center; padding-top:30px; padding-bottom:50px\">");                    
                    mensajeCorreo.AppendLine(String.Format("			<a href=\"{0}Pedido/Index?lanzarTabConsultoraOnline=true\" target=\"_blank\"><img src=\"{1}\" width=\"201\" height=\"38\" border=\"0\" alt=\"Ver pedido\"></a>", contextoBase, ConfigS3.GetUrlFileCdn(carpetaPais, "7-Mailing_03.png")));
                    mensajeCorreo.AppendLine("</td>");
                    mensajeCorreo.AppendLine("</tr>");
                    mensajeCorreo.AppendLine("<tr>");
                    mensajeCorreo.AppendLine("<td colspan=\"7\" style=\"background-color:#acbbc9;\">");
                    mensajeCorreo.AppendLine(String.Format("<img src=\"{0}\" width=\"611\" height=\"30\" alt=\"\" align=\"left\">", ConfigS3.GetUrlFileCdn(carpetaPais, "1-Mailing_12.png")));
                    mensajeCorreo.AppendLine("<a href=\"http://www.facebook.com/SomosBelcorpOficial\" target=\"_blank\">");
                    mensajeCorreo.AppendLine(String.Format("<img src=\"{0}\" width=\"26\" height=\"30\" border=\"0\" alt=\"Facebook\" align=\"left\"></a>", ConfigS3.GetUrlFileCdn(carpetaPais, "Facebook.png")));
                    mensajeCorreo.AppendLine("<a href=\"https://www.youtube.com/user/somosbelcorp\" target=\"_blank\">");
                    mensajeCorreo.AppendLine(String.Format("<img src=\"{0}\" width=\"27\" height=\"30\" border=\"0\" alt=\"Youtube\" align=\"left\"></a>", ConfigS3.GetUrlFileCdn(carpetaPais, "Youtube.png")));
                    mensajeCorreo.AppendLine("</td>");
                    mensajeCorreo.AppendLine("</tr>");
                    mensajeCorreo.AppendLine("<tr>");
