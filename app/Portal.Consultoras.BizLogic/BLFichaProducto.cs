    ...
    public class BLFichaProducto
    {
        public List<BEFichaProducto> GetFichaProducto(BEFichaProducto entidad)
        {
            ...
            fichasProductosResult.ForEach(ficha =>
            {
                ...
                ficha.FotoProducto01 = string.IsNullOrEmpty(ficha.FotoProducto01) ? string.Empty : ficha.FotoProducto01.StartsWith("http") ? ficha.FotoProducto01 : ConfigCdn.GetUrlFileCdn(carpetaPais, ficha.FotoProducto01);
