...
namespace Portal.Consultoras.BizLogic.Reserva
{
    public class BLReserva : IReservaBusinessLogic
    {
        ...
        private bool EnviarPorCorreoPedidoValidado(BEInputReservaProl input, List<BEPedidoWebDetalle> olstPedidoWebDetalle)
        {
            ...
            if (esEsika) mailBody.Append("<img src='" + Globals.RutaCdn + "/ImagenesPortal/Iconos/logo.png' alt='Logo Esika'/>");
            else mailBody.Append("<img src='" + Globals.RutaCdn + "/ImagenesPortal/Iconos/logod.png' alt='Logo Lbel'/>");
            ...
            else if(input.PaisID == Constantes.PaisID.CostaRica)
            {
                ...
                mailBody.AppendFormat("<tr> <td style = 'width: 50%; font-family: Arial; font-size: 13px; color: {0}; font-weight:700; padding-left: 14%; text-align:left; padding-bottom: 20px; padding-top: 5px' > Ganancia estimada total: </td>", colorStyle);
            }
            ...
            {
               mailBody.AppendFormat("<tr><td style = 'width: 50%; font-family: Arial; font-size: 13px; color: {0}; font-weight:700; padding-left: 10px; text-align:left; padding-bottom: 13px; padding-top: 5px;' > Ganancia estimada total:</td>", colorStyle);
            ...
            mailBody.Append(" <td style='width: 8 %; text - align:left; '> <a href = 'http://www.esika.com/' > <img src = '" + Globals.RutaCdn + "/ImagenesPortal/Iconos/logo-esika.png' alt = 'Logo Esika' /> </a></td> ");
            mailBody.Append(" <td style='width: 8 %; text - align:left; '> <a href = 'http://www.lbel.com/' > <img src = '" + Globals.RutaCdn + "/ImagenesPortal/Iconos/logo-lbel.png' alt = 'Logo L'bel' /></a></td> ");
            mailBody.Append(" <td style='width: 15 %; text - align:left; border - right:1px solid #FFF;'><a href = 'http://www.cyzone.com/' ><img src = '" + Globals.RutaCdn + "/Correo/logo-cyzone.png' alt = 'Logo Cyzone' /> </a></td>");
            ...
            mailBody.Append(" <td style = 'text-align: right; position: relative; top: 2px; left: 10px; width: 20%; vertical-align: top;' > <img src = '" + Globals.RutaCdn + "/ImagenesPortal/Iconos/logo-facebook.png' alt = 'Logo Facebook' /> </td></tr></tbody></table ></td> </tr></table> </td> </tr> ");
