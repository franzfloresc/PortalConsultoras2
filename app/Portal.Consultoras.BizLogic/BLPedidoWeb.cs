            ...
            catch (Exception ex)
            {
                if (nroLote > 0)
                {
                    ...
                    if (ConfigurationManager.AppSettings["OrderDownloadIncludeDatosConsultora"] == "1" && tipoCronograma == 1) //VVA CO528
                    {
                        ...
                        MailUtilities.EnviarMailProcesoDescargaExcepcion("ActualizaciÃ³n Datos Consultora", codigoPais, FechaHoraPais, descripcionProceso, ErrorCoDat, errorExcepcion);
                    }
                }
                throw;
            }
