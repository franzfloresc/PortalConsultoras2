...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			inner join ods.ProductoComercial pr with(nolock) on cr.CampaniaId = pr.CampaniaID and pd.CUV = pr.CUV
...
--**********************************Cupon***********************************
	 ...
	 begin   
	  ...
	  Where   
	   ...
	   pedido_detalle.CodigoCatalago in (35,44,45,46)  --Los valores relaciones son: 35 (Oferta Final), 44 (Showroom), 45 (Ofertas Para Ti) y 46 (Oferta Del Día)  
	 End   
 --**********************************Cupon ***********************************
