...
USE BelcorpPeru
GO
IF NOT EXISTS (SELECT * FROM configuracionpaisDatos WHERE codigo = 'FlagFiltrosBuscador')
BEGIN
	...
	VALUES (@id, 'FlagFiltrosBuscador',0, 1, NULL, NULL, 'Flag para activar filtros en la página de resultados.', 1, NULL)
END
