...
BEGIN    
 ...
 LEFT JOIN Estrategia EST ON PWD.CampaniaID BETWEEN EST.CampaniaID 
	...
	AND EST.Activo=1 AND EST.Numeropedido = (CASE WHEN @ProgramaNuevoActivado = 0 THEN 0 ELSE @NumeroPedido END)   
...
ALTER PROCEDURE [dbo].[GetPedidoWebByFechaFacturacion] --'2014-06-05',1,1
