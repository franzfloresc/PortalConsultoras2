...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetPedidoWebByFechaFacturacion]') AND type in (N'P', N'PC')) 
 DROP PROCEDURE [dbo].[GetPedidoWebByFechaFacturacion]
GO


CREATE PROCEDURE [dbo].[GetPedidoWebByFechaFacturacion] --'2015-10-19',1,1  
