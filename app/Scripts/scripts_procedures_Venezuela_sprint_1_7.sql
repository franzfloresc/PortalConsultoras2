...
CREATE SYNONYM [ods].[OfertasPersonalizadas] FOR [ODS_VE].[dbo].[OfertasPersonalizadas]
GO
...
CREATE SYNONYM [ods].[ConfiguracionProgramaNuevas] FOR [ODS_VE].[dbo].[ConfiguracionProgramaNuevas]
GO
...
INSERT [dbo].[Permiso] ([PermisoID], [Descripcion], [IdPadre], [OrdenItem], [UrlItem], [PaginaNueva], [Posicion], [UrlImagen], [EsSoloImagen], [EsMenuEspecial], [EsServicios], [EsPrincipal]) 
VALUES (1044, N'TÉRMINOS Y CONDICIONES', 1041, 1, N'https://www.somosbelcorp.com/WebPages/TerminosyReferencias_VE.aspx', 1, N'Footer', NULL, 0, 0, 0, 1)
--INSERT [dbo].[Permiso] ([PermisoID], [Descripcion], [IdPadre], [OrdenItem], [UrlItem], [PaginaNueva], [Posicion], [UrlImagen], [EsSoloImagen], [EsMenuEspecial], [EsServicios], [EsPrincipal]) 
...
--(11, 'Pedido FIC', 1, 2, 'Mobile/PedidoCliente', '', 0, 'Menu', 'Mobile'),
...
BEGIN
	...
	from SolicitudCliente where ConsultoraID = @ConsultoraId and (Estado IS NULL or LTRIM(RTRIM(Estado)) IN ('A','R', 'C'))
