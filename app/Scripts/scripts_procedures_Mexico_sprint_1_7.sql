...
CREATE SYNONYM [ods].[OfertasPersonalizadas] FOR [ODS_MX].[dbo].[OfertasPersonalizadas]
GO
...
CREATE SYNONYM [ods].[ConfiguracionProgramaNuevas] FOR [ODS_MX].[dbo].[ConfiguracionProgramaNuevas]
GO
...
CREATE SYNONYM [ods].[EscalaDescuento] FOR [ODS_MX].[dbo].[EscalaDescuento]
GO
...
CREATE SYNONYM [ods].[INT_SOA_COBRA_DEUDA_SECCI] FOR [ODS_MX].[ffvv].[INT_SOA_COBRA_DEUDA_SECCI]
...
INSERT [dbo].[Permiso] ([PermisoID], [Descripcion], [IdPadre], [OrdenItem], [UrlItem], [PaginaNueva], [Posicion], [UrlImagen], [EsSoloImagen], [EsMenuEspecial], [EsServicios], [EsPrincipal]) 
VALUES (1042, N'PREGUNTAS FRECUENTES', 1040, 1, N'https://www.somosbelcorp.com/Content/FAQ/Preguntas frecuentes Portal Consultora MX.pdf', 1, N'Footer', NULL, 0, 0, 0, 1)
INSERT [dbo].[Permiso] ([PermisoID], [Descripcion], [IdPadre], [OrdenItem], [UrlItem], [PaginaNueva], [Posicion], [UrlImagen], [EsSoloImagen], [EsMenuEspecial], [EsServicios], [EsPrincipal]) 
VALUES (1043, N'CONTÁCTANOS', 1040, 2, N'http://belcorprespondeqa.somosbelcorp.com/', 1, N'Footer', NULL, 0, 0, 0, 1)
INSERT [dbo].[Permiso] ([PermisoID], [Descripcion], [IdPadre], [OrdenItem], [UrlItem], [PaginaNueva], [Posicion], [UrlImagen], [EsSoloImagen], [EsMenuEspecial], [EsServicios], [EsPrincipal]) 
VALUES (1044, N'CONDICIONES DE USO WEB', 1041, 1, N'https://www.somosbelcorp.com/Content/FAQ/CONDICIONES_DE_USO_WEB_MX.pdf', 1, N'Footer', NULL, 0, 0, 0, 1)
INSERT [dbo].[Permiso] ([PermisoID], [Descripcion], [IdPadre], [OrdenItem], [UrlItem], [PaginaNueva], [Posicion], [UrlImagen], [EsSoloImagen], [EsMenuEspecial], [EsServicios], [EsPrincipal]) 
VALUES (1045, N'POLÍTICAS DE PRIVACIDAD', 1041, 2, N'https://www.somosbelcorp.com/Content/FAQ/POLITICA_DE_PRIVACIDAD_MX.pdf', 1, N'Footer', NULL, 0, 0, 0, 1)
-- FIN FOOTER
...
INSERT INTO MenuMobile (MenuMobileID
				...
				VALUES (1022
						...
						,1018
						,1
						,'https://www.somosbelcorp.com/WebPages/TerminosyReferencias_MX.aspx'
						,''
						,1
						,'Footer'
						,'Completa',1)
