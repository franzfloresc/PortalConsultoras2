...
BEGIN  
	...
	BEGIN TRY  
		...
		IF EXISTS(SELECT 1 FROM dbo.TipoEstrategia (NOLOCK) WHERE Codigo = @Codigo AND TipoEstrategiaID <> @TipoEstrategiaID )  
		BEGIN  
			RAISERROR('El C�digo del tipo estrategia ya existe.', 16, 1)  
		END 
