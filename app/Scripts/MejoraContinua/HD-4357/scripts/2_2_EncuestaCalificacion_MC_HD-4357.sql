...
INSERT [dbo].[EncuestaCalificacion] ([Id], [EncuestaId], [Descripcion],[PreguntaDescripcion], [CreatedBy],[TipoCalificacion],[CssClass],[Imagen]) VALUES (1, 1,'Pésimo','¿A qué se debe tu calificación?', N'EINCA',1,'pesimo','pesimo.svg');
INSERT [dbo].[EncuestaCalificacion] ([Id], [EncuestaId], [Descripcion],[PreguntaDescripcion], [CreatedBy],[TipoCalificacion],[CssClass],[Imagen]) VALUES (2, 1,'Malo','¿A qué se debe tu calificación?', N'EINCA',1,'malo','mal.svg');
