...
INSERT INTO TablaLogicaDatos (TablaLogicaDatosID, TablaLogicaID, Codigo, Descripcion, Valor)VALUES(cast(@TablaLogicaID as varchar(3)) + '07', @TablaLogicaID, 'HistLimitDetMensaje', 'Tener en cuenta el límite de Historias, su número máximo es de {0}, si supera el límite se desactiva la primera Historia.', NULL);
