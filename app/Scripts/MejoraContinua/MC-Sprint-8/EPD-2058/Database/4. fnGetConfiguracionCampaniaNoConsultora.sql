...
IF OBJECT_ID(N'dbo.fnGetConfiguracionCampaniaNoConsultora') IS NOT NULL
BEGIN
    DROP FUNCTION dbo.fnGetConfiguracionCampaniaNoConsultora
END
GO

CREATE FUNCTION [dbo].[fnGetConfiguracionCampaniaNoConsultora]
(
	@PaisID tinyint,
	@ZonaID int,
	@RegionID int
