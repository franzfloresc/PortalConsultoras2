...
BEGIN TRAN
	...
	FROM(
		...
		WHERE U.CODIGOCONSULTORA IS NULL AND ((LEN(I.Numero) = 10 AND I.TipoDocumento = 'CCI') OR  (I.TipoDocumento = 'PSSPT') OR (I.TipoDocumento = 'RUC'))
		AND ISNULL(I.NUMERO,'') <> ''
	) T
	...
	IF @CANTIDAD_REGISTROS>0
			BEGIN 
				...
				FROM @TB_INFORMACION T 
				WHERE NOT EXISTS(SELECT 1 FROM DBO.USUARIO WHERE codigousuario = T.NUMERO_IDENTIFICACION AND TIPOUSUARIO <> 2)
