...
BEGIN TRAN
	...
	FROM(
		...
		LEFT JOIN ODS.IDENTIFICACION I ON C.CONSULTORAID = I.CONSULTORAID  AND I.DOCUMENTOPRINCIPAL = '1' AND I.TIPODOCUMENTO = 'CI'
		LEFT JOIN USUARIO U ON C.CODIGO = U.CODIGOCONSULTORA
		LEFT JOIN ODS.ZONA Z ON C.ZONAID = Z.ZONAID
		WHERE U.CODIGOCONSULTORA IS NULL
		AND ISNULL(I.NUMERO,'')<>''
	) T
