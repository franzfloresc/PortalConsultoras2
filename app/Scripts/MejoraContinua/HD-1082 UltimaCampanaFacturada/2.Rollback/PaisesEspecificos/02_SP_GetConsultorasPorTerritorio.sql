USE BelcorpBolivia
GO
ALTER PROCEDURE dbo.GetConsultorasPorTerritorio
(
	@PaisId INT,
...
BEGIN
	...
	INNER JOIN ods.Ubigeo OUB with(nolock) ON T.CodigoUbigeo = OUB.CodigoUbigeo
