...
begin
	...
	begin
		...
		from PedidoDD p
		join TempPedidoDDID pk on p.CampaniaID = pk.CampaniaID and 
		   			  p.PedidoID = pk.PedidoID
	...
	begin
		...
		join TempPedidoDDDetID pk on p.CampaniaID = pk.CampaniaID and 
		   			  p.PedidoID = pk.PedidoID and p.PedidoDetalleID = pk.PedidoDetalleID
		where pk.NroLote = @intNroLote
	end
