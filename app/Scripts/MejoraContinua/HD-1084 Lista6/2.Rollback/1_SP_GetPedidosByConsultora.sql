USE BelcorpBolivia
GO
ALTER PROCEDURE [dbo].[GetPedidosByConsultora] --'0005854'
(
...
select top 4 Consultora, NumeroPedido, Campana, Estado, Fecha
from @Temp
order BY Campana DESC, Fecha DESC
END
GO
...
select top 4 t.Consultora, t.NumeroPedido, t.Campana, 
case when pfr.Periodo is null then t.Estado else 'ANULADO' end Estado,
t.Fecha
from @Temp t
left join ods.PedidoFacturadoRechazado pfr with(nolock) on t.Campana = pfr.Periodo and t.Consultora = pfr.CodigoConsultora and
