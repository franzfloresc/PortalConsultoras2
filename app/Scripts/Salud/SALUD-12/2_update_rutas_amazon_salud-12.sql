...
declare @BucketAntiguoQA varchar(100) = 'S3.amazonaws.com/consultorasQAS/SomosBelcorp/'
declare @BucketNuevoQA varchar(100) = 'd1y60eoca8fkyl.cloudfront.net/'

declare @BucketAntiguoPRD varchar(100) = 'S3.amazonaws.com/consultorasPRD/SomosBelcorp/'
declare @BucketNuevoPRD varchar(100) = 'd1y60eoca8fkyl.cloudfront.net/'
