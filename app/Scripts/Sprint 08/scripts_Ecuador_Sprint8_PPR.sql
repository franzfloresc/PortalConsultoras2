...
CREATE SYNONYM [ods].[ProductosLanzamiento] FOR [ODS_EC].[dbo].[ProductosLanzamiento]
GO
--FIN SINONIMOS
...
begin
	...
	VALUES(@PermisoID+2, 'Administrar ShowRoom', 111, @OrdenItem+1,'ShowRoom/AdministrarShowRoom',0,'Header','',0,0,0)
	INSERT INTO RolPermiso(RolID, PermisoID, Activo, Mostrar) VALUES(4,@PermisoID+2,1,1)
