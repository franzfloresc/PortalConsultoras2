...
CREATE SYNONYM [ods].[ProductosLanzamiento] FOR [ODS_PE].[dbo].[ProductosLanzamiento]
GO
...
AS
/*
dbo.GetProductoComercialByCampaniaBySearchRegionZona_SB2 201614,1,1,'00040',2701,2161,'50','5052'
