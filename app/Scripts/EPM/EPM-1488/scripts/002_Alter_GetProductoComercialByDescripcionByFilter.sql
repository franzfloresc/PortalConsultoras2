...
IF (OBJECT_ID ( 'dbo.GetProductoComercialByDescripcionByFilter', 'P' ) IS NULL)
EXEC('CREATE PROCEDURE dbo.GetProductoComercialByDescripcionByFilter AS SET NOCOUNT ON;')
GO
