...
begin
	...
	FROM 
		ods.consultora C LEFT JOIN ods.Identificacion I
								on C.ConsultoraID = I.ConsultoraID AND I.TipoDocumento = 'CI'
								LEFT JOIN Usuario U
...
begin
	...
	FROM 
		ods.consultora C LEFT JOIN ods.Identificacion I
								on C.ConsultoraID = I.ConsultoraID AND I.TipoDocumento = 'RUT'
								LEFT JOIN ConsultoraIngreso U
...
begin
	...
	FROM 
		ods.consultora C LEFT JOIN ods.Identificacion I
								on C.ConsultoraID = I.ConsultoraID AND I.TipoDocumento = 'CCI' --AND I.DocumentoPrincipal = '1'
								LEFT JOIN Usuario U
								on C.Codigo = U.CodigoConsultora
								LEFT JOIN ods.Zona Z
								on C.ZonaID = Z.ZonaID
