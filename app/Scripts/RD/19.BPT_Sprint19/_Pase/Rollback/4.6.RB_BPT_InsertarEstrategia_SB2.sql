...
BEGIN
	...
	BEGIN TRY
		...
		-- Para calcular la etiqueta Oferta del dia
		...
		-- Obtener el EtiquetaID de la Oferta del dia.
		...
		BEGIN
			...
			BEGIN
				RAISERROR('El valor de cuv2 a registrar ya existe para el tipo de estrategia y rango de campaña seleccionado.', 16, 1)
			END	
		END						 
