USE [BelcorpPeru_BPT]
GO
/****** Object:  StoredProcedure [dbo].[GetPedidoWebDetalleByCampania]    Script Date: 29/01/2018 16:43:00 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	INNER JOIN Producto P WITH(NOLOCK) ON E.CampaniaID = P.CampaniaID and E.CUV2 = P.CUV 
