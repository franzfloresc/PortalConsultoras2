USE BelcorpBolivia
GO
  IF OBJECT_ID('dbo.GetPedidoWebDetalleByCampania', 'P') IS NOT NULL
	DROP PROC dbo.GetPedidoWebDetalleByCampania
GO
CREATE PROCEDURE dbo.GetPedidoWebDetalleByCampania 
 @CampaniaID  INT,  
 @ConsultoraID BIGINT,  
...
BEGIN  
 ...
 SELECT   
  ...
  PWD.CUV,  
  PWD.EsKitNueva,  
  COALESCE(EST.DescripcionEstrategia, PWD.DescripcionProd) AS DescripcionProd, --ANTERIOR
