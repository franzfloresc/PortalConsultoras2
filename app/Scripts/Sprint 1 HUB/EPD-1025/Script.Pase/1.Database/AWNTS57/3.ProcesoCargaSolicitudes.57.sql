...
MontoMeta varchar(19), DescripcionMeta varchar(50)
)
...
case when MontoMeta > 0 then convert(varchar(19),MontoMeta) else '' end, DescripcionMeta
...
'',
TipoMeta,
case when MontoMeta > 0 then convert(varchar(19),MontoMeta) else '' end,
DescripcionMeta
from SolicitudCredito
where isnull(CodigoLote,0)=0
insert into SolicitudCreditoLog (SolicitudCreditoID,NumeroLote,FechaIngreso)
