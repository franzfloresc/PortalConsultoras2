...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ConsultarOfertaByCUV]') AND type in (N'P', N'PC')) 
	DROP PROCEDURE [dbo].[ConsultarOfertaByCUV]
GO

CREATE PROCEDURE ConsultarOfertaByCUV
	@CampaniaID		  INT,
	@CUV2			  VARCHAR(20),
