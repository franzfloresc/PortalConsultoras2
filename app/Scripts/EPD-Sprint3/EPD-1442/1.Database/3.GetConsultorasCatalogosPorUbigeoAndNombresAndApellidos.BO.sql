...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetConsultorasCatalogosPorUbigeoAndNombresAndApellidos]') AND type in (N'P', N'PC')) 
	DROP PROCEDURE [dbo].[GetConsultorasCatalogosPorUbigeoAndNombresAndApellidos]
GO

CREATE PROCEDURE dbo.GetConsultorasCatalogosPorUbigeoAndNombresAndApellidos
	@PaisId int,
