...
DECLARE @OrdenInverso nvarchar(1024)    
	...
	SET @SentenciaPrincipal = ' 
								...
								CAST(P.Cuv AS VARCHAR(20)) AS Cuv, PC.Descripcion AS Producto, ISNULL(M.Nombre,'''') AS Marca, CAST(ISNULL(P.Cantidad, ''0'') AS VARCHAR(20)) AS Cantidad, 
								...
								ISNULL(PP.MensajePROL,'''') AS Observacion
								...
								LEFT JOIN PedidoWebAccionesPROL AS PP on P.PedidoWebAccionesPROLID = PP.PedidoWebAccionesPROLID
