...
CREATE PROCEDURE [dbo].[GetPedidoWebDetalleByCampania] @CampaniaID int  
, @ConsultoraID bigint  
  ...
  BEGIN  
    ...
    INSERT INTO @Estrategia2  
      ...
      INNER JOIN @PedidoDetalle2 PWD  
        ...
        AND E.CUV2 = PWD.CUV  
        AND E.Activo = 1  
        AND PWD.CodigoTipoEstrategia NOT IN ('001', '030', '008', '007', '005', '010')  
    ...
    WHERE PWD.CodigoTipoEstrategia NOT IN ('001', '030', '008', '007', '005', '010')
    ...
    AND PWS.ConsultoraID = @ConsultoraID  and PWD.CodigoTipoEstrategia IN ('001', '030', '008', '007', '005', '010')
