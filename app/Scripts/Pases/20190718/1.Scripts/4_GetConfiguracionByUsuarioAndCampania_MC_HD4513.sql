...
BEGIN
  ...
  /******HD-3693********/
  declare @AutorizaPedido char(1)=1;
  /******HD-3693********/  
  declare @EsPagoContado bit = 0;/*HD-4513*/    
  ...
  BEGIN
    ...
    BEGIN
      select
		...
		/******HD-3693********/
		@AutorizaPedido= C.AutorizaPedido
		/******HD-3693********/
	   ,@EsPagoContado=C.PagoContado /*HD-4513*/
  ...
  select
	...
	/******HD-3693********/
	@AutorizaPedido as AutorizaPedido
	/******HD-3693********/
	,@EsPagoContado as PagoContado/* HD-4513 */
  FROM Pais P (nolock)
