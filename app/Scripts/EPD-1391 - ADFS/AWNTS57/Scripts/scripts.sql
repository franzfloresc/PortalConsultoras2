...
as
/*
select dbo.GenerarClaveDefault('0000003')
*/
begin
	declare @resultado varchar(100) = ''
	...
	select @Numero = Numero from ods.Identificacion where ConsultoraID = @ConsultoraID
	
	set @resultado = substring(@Numero, len(@Numero)-3,4)
...
as
/*
select dbo.GenerarClaveDefault('0000228')
select dbo.GenerarClaveDefault('0000203')
*/
begin
	declare @resultado varchar(100) = ''
	...
	--select * from ods.identificacion where Numero like '%-%'
	--select * from ods.consultora where consultoraid in (256,2)
...
as
/*
select dbo.GenerarClaveDefault('0000094')
*/
begin
	declare @resultado varchar(100) = ''
...
as
/*
select dbo.GenerarClaveDefault('0100002')
*/
begin
	declare @resultado varchar(100) = ''
...
as
/*
select dbo.GenerarClaveDefault('000000019')
*/
begin
	declare @resultado varchar(100) = ''
	...
	--select * from ods.consultora where consultoraid=48793220
	--select * from ods.identificacion where consultoraid=48793220
...
as
/*
select dbo.GenerarClaveDefault('0000206')
*/
begin
	declare @resultado varchar(100) = ''
...
as
/*
select dbo.GenerarClaveDefault('0100060')
*/
begin
	declare @resultado varchar(100) = ''
...
as
/*
select dbo.GenerarClaveDefault('0000435')
*/
begin
	declare @resultado varchar(100) = ''
