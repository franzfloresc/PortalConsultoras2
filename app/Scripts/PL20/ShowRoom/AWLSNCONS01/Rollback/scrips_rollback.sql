...
if (select COUNT(*) from dbo.sysobjects inner join dbo.syscolumns on SYSOBJECTS.ID = SYSCOLUMNS.ID 
	where sysobjects.id = object_id('ShowRoom.EventoConsultora') and SYSCOLUMNS.NAME = N'Suscripcion') = 1
	ALTER TABLE ShowRoom.EventoConsultora drop column Suscripcion
go

if (select COUNT(*) from dbo.sysobjects inner join dbo.syscolumns on SYSOBJECTS.ID = SYSCOLUMNS.ID 
	where sysobjects.id = object_id('ShowRoom.EventoConsultora') and SYSCOLUMNS.NAME = N'Envio') = 1
	ALTER TABLE ShowRoom.EventoConsultora drop column Envio
go

if (select COUNT(*) from dbo.sysobjects inner join dbo.syscolumns on SYSOBJECTS.ID = SYSCOLUMNS.ID 
	where sysobjects.id = object_id('ShowRoom.EventoConsultora') and SYSCOLUMNS.NAME = N'CorreoEnvioAviso') = 1
	ALTER TABLE ShowRoom.EventoConsultora drop column CorreoEnvioAviso
go

if (select COUNT(*) from dbo.sysobjects inner join dbo.syscolumns on SYSOBJECTS.ID = SYSCOLUMNS.ID 
	where sysobjects.id = object_id('ShowRoom.EventoConsultora') and SYSCOLUMNS.NAME = N'Recibido') = 1
	ALTER TABLE ShowRoom.EventoConsultora drop column Recibido
go
