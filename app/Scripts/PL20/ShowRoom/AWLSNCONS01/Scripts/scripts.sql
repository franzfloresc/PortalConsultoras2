...
insert into ShowRoom.Personalizacion (TipoAplicacion,Atributo,TextoAyuda,TipoAtributo,TipoPersonalizacion,Orden,Estado)
values ('Desktop','TituloPrincipal','Título de la Categoria','TEXTO','CATEGORIA',8,1)
insert into ShowRoom.Personalizacion (TipoAplicacion,Atributo,TextoAyuda,TipoAtributo,TipoPersonalizacion,Orden,Estado)
values ('Desktop','ImagenPrincipal','Imagen a mostrar en la Categoria','IMAGEN','CATEGORIA',9,1)
insert into ShowRoom.Personalizacion (TipoAplicacion,Atributo,TextoAyuda,TipoAtributo,TipoPersonalizacion,Orden,Estado)
values ('Desktop','ColorFondo','Color de Fondo de la Categoria','TEXTO','CATEGORIA',10,1)
...
insert into ShowRoom.Personalizacion (TipoAplicacion,Atributo,TextoAyuda,TipoAtributo,TipoPersonalizacion,Orden,Estado)
values ('Mobile','TituloPrincipal','Título de la Categoria','TEXTO','CATEGORIA',9,1)
insert into ShowRoom.Personalizacion (TipoAplicacion,Atributo,TextoAyuda,TipoAtributo,TipoPersonalizacion,Orden,Estado)
values ('Mobile','ColorFondo','Color de Fondo de la Categoria','TEXTO','CATEGORIA',10,1)
