/*
* ACTUALIZAR LA TABLA ESTRATEGIA TEMPORAL TYPE
* STORE InsertEstrategiaOfertaParaTi VARIA POR PAIS
*/

USE BelcorpPeru
GO

/* Eliminar referencias de la tabla type*/
...
/* Crear Referencias actualizadas */ 
...
(CampaniaId,CUV,Descripcion,PrecioOferta,PrecioTachado,CodigoSap,OfertaUltimoMinuto,LimiteVenta,NumeroLote,FechaCreacion,UsuarioCreacion,FotoProducto01, CodigoEstrategia, TieneVariedad)
select
CampaniaId,CUV,Descripcion,PrecioOferta,PrecioTachado,CodigoSap,OfertaUltimoMinuto,LimiteVenta,@NumeroLote,@FechaGeneral,UsuarioCreacion,FotoProducto01, CodigoEstrategia, TieneVariedad
