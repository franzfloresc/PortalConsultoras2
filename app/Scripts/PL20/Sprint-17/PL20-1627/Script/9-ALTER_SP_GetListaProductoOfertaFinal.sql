...
go
Create PROCEDURE [dbo].[GetListaProductoOfertaFinal]
(
...
BEGIN
	...
	*/
	...
	BEGIN
			...
			IF (@MontoTotal > @MontoMinPedido)
				IF @MontoEscala > @MontoMinPedido
					SET @MontoFaltante = 0
				ELSE
					SET @MontoFaltante = (@MontoMinPedido - @MontoEscala)
			ELSE
				SET @MontoFaltante = (@MontoMinPedido - @MontoTotal)
	...
	END -- ELSE (@TipoProductoMostrar = 1)
