...
namespace Portal.Consultoras.Entities
{
    ...
    public class BEShowRoomEvento
    {
        ...
        public BEShowRoomEvento(IDataRecord datarec)
        {
            ...
            if (DataRecord.HasColumn(datarec, "RutaShowRoomPopup") && datarec["RutaShowRoomPopup"] != DBNull.Value)
                RutaShowRoomPopup = DbConvert.ToString(datarec["RutaShowRoomPopup"]);
            if (DataRecord.HasColumn(datarec, "RutaShowRoomBannerLateral") && datarec["RutaShowRoomBannerLateral"] != DBNull.Value)
                RutaShowRoomBannerLateral = DbConvert.ToString(datarec["RutaShowRoomBannerLateral"]);
