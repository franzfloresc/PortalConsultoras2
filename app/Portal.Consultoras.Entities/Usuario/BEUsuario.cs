...
namespace Portal.Consultoras.Entities
{
    ...
    public class BEUsuario
    {
        ...
        public BEUsuario(IDataRecord row, bool Tipo)
        {
            ...
            BanderaImagen = row.ToString("BanderaImagen");
            msSimbolo = row.ToString("Simbolo");
            FechaModificacion = Convert.ToDateTime("FechaModificacion");
            Rol = Convert.ToString("Rol");
            CampanaInvitada = Convert.ToString("CampanaInvitada");
            InscritaFlexipago = Convert.ToString("InscritaFlexipago");
            InvitacionRechazada = Convert.ToString("InvitacionRechazada");
            SegmentoConstancia = Convert.ToString("SegmentoConstancia");
            SeccionAnalytics = Convert.ToString("Seccion");
            DescripcionNivel = Convert.ToString("DescripcionNivel");
            esConsultoraLider = Convert.ToBoolean("esConsultoraLider");
            EMailActivo = Convert.ToBoolean("EMailActivo");
            SegmentoInternoID = Convert.ToInt32("SegmentoInternoId");
            EstadoSimplificacionCUV = Convert.ToBoolean("EstadoSimplificacionCUV");
            bEsquemaDAConsultora = Convert.ToBoolean("EsquemaDAConsultora");
            OfertaFinal = Convert.ToInt32("OfertaFinal");
            EsOfertaFinalZonaValida = Convert.ToBoolean("EsOfertaFinalZonaValida");
            OfertaFinalGanaMas = Convert.ToInt32("OfertaFinalGanaMas");
            EsOFGanaMasZonaValida = Convert.ToBoolean("EsOFGanaMasZonaValida");
            CatalogoPersonalizado = Convert.ToInt32("CatalogoPersonalizado");
            EsCatalogoPersonalizadoZonaValida = Convert.ToBoolean("EsCatalogoPersonalizadoZonaValida");
            VioTutorialSalvavidas = Convert.ToInt32("VioTutorialSalvavidas");
            TieneHana = Convert.ToInt32("TieneHana");
            IndicadorBloqueoCDR = Convert.ToInt32("IndicadorBloqueoCDR");
            EsCDRWebZonaValida = Convert.ToInt32("EsCDRWebZonaValida");
            TieneCDR = Convert.ToInt32("TieneCDR");
            TieneCupon = Convert.ToInt32("TieneCupon");
            TieneMasVendidos = Convert.ToInt32("TieneMasVendidos");
            TieneAsesoraOnline = Convert.ToInt32("TieneAsesoraOnline");
            TieneOfertaLog = Convert.ToInt32("TieneOfertaLog");
            IndicadorGPRSB = Convert.ToInt32("IndicadorGPRSB");
            EstadoPedido = Convert.ToInt32("EstadoPedido");
            ValidacionAbierta = Convert.ToBoolean("ValidacionAbierta");
            NombreGerenteZona = Convert.ToString("GerenteZona");
            digitoVerificador = Convert.ToString("DigitoVerificador");
            OfertaDelDia = Convert.ToBoolean("TieneODD");
            consultoraAsociadoID = Convert.ToInt64("ConsultoraAsociadoID");
            DocumentoIdentidad = Convert.ToString("DocumentoIdentidad");
            TipoUsuario = Convert.ToInt16("TipoUsuario");
            TieneLoginExterno = Convert.ToBoolean("TieneLoginExterno");
            TieneCDRExpress = row.ToBoolean("TieneCDRExpress");
            EsConsecutivoNueva = row.ToBoolean("EsConsecutivoNueva");
