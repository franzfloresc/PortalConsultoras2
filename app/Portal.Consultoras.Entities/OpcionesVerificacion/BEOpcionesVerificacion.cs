...
namespace Portal.Consultoras.Entities.OpcionesVerificacion
{
    ...
    public class BEOpcionesVerificacion
    {
        ...
        public BEOpcionesVerificacion(IDataRecord row)
        {
            ...
            //INI HD-3897
            OpcionConfirmarEmail = (row.HasColumn("OpcionConfirmarEmail") ? row.ToBoolean("OpcionConfirmarEmail") : false);
            OpcionConfirmarSms = (row.HasColumn("OpcionConfirmarSms") ? row.ToBoolean("OpcionConfirmarSms") : false);
            //FIN HD-3897
        }
    }
