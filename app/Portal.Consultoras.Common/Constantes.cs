...
namespace Portal.Consultoras.Common
{
    public class Constantes
    {
        ...
        public static class MensajesError
        {
            ...
            public const string ExcedioLimiteVenta = "En esta campaña nuestro producto <b>{0} – {1}</b> ha tenido una gran acogida. Sin embargo hemos reservado una ({2}) unidad(es) para ti. Por favor modifica las unidades ingresadas."; //"Las unidades ingresadas exceden el máximo permitido ({0}) en esta campaña.";
