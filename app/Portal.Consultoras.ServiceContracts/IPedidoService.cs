...
namespace Portal.Consultoras.ServiceContracts
{
    ...
    public interface IPedidoService
    {
        ...
        [OperationContract]
        List<BEPedidoWeb> GetPedidosIngresadoFacturadoWebMobile(int paisID, int consultoraID, int campaniaID, int top, string codigoConsultora);
        ...
        [OperationContract]
        List<BEConsultoraConcurso> ObtenerPuntosXConsultoraConcurso(int PaisID, string CodigoCampania, string CodigoConsultora, string CodigoConcurso);
    }
}
