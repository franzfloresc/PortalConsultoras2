...
namespace Portal.Consultoras.ServiceContracts
{
    ...
    public interface IPedidoService
    {
        ...
        [OperationContract]
        List<BEPedidoWeb> GetPedidosIngresadoFacturadoApp(int paisID, int consultoraID, int campaniaID, string codigoConsultora, int usuarioPrueba, string consultoraAsociada);
