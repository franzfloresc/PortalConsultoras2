...
namespace Portal.Consultoras.ServiceContracts
{
    ...
    public interface IODSService
    {
        ...
        [OperationContract]
        Enumeradores.ValidacionProgramaNuevas ValidarBusquedaProgramaNuevas(int paisID, int campaniaID, int ConsultoraID, string codigoPrograma, int consecutivoNueva, string cuv, bool consultoraNueva, bool participaProgramaNuevas);
